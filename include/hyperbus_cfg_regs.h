...
// reg - hyperbus_cfg_regs::dual_phy
#define HYPERBUS_CFG_REGS__DUAL_PHY__VALUE_bm 0x1
#define HYPERBUS_CFG_REGS__DUAL_PHY__VALUE_bp 0
#define HYPERBUS_CFG_REGS__DUAL_PHY__VALUE_bw 1
#define HYPERBUS_CFG_REGS__DUAL_PHY__VALUE_reset 0x1
...
// reg - hyperbus_cfg_regs::flush
#define HYPERBUS_CFG_REGS__FLUSH__REQUEST_bm 0x1
#define HYPERBUS_CFG_REGS__FLUSH__REQUEST_bp 0
#define HYPERBUS_CFG_REGS__FLUSH__REQUEST_bw 1
