...
module hyperbus_iso_bridge #(
    ...
    assign cmd_src_fire       = frontend_cmd_valid_i && frontend_cmd_ready_o;
    assign wrsp_src_fire      = backend_wrsp_valid_i && backend_wrsp_ready_o;
    ...
    `FFLARN(cfg_apply_data_q, cfg_apply_i, cfg_apply_src_fire, '0, clk_sys_i, rst_sys_ni)
    `FFARN(cfg_apply_pending_q, cfg_apply_pending_d, 1'b0, clk_sys_i, rst_sys_ni)
    `FFLARN(cmd_data_q, frontend_cmd_i, cmd_src_fire, '0, clk_sys_i, rst_sys_ni)
    `FFLARN(wrsp_error_q, backend_wrsp_error_i, wrsp_src_fire, 1'b0, clk_phy_i, rst_phy_ni)
    ...
    assign backend_cmd_o = cmd_data_q;
    ...
    assign frontend_wrsp_error_o = wrsp_error_q;
